...
import { toPromise as f, take as h, filter as k, subscribe as y, map as m, tap as x, merge as g, mergeMap as w, takeUntil as E, make as O, onPush as N, share as b, fromPromise as q, fromValue as _, makeSubject as D, lazy as S, onStart as P, switchMap as R, publish as V, takeWhile as A, onEnd as M } from "wonka";
...
var cacheExchange = ({forward: e, client: r, dispatchDebug: t}) => {
  ...
  return o => {
    ...
    var c = x((e => {
      ...
      cacheOutcome: "miss"
    }) : e))(g([ m(mapTypeNames)(k((e => !shouldSkip(e) && !isOperationCached(e)))(o)), k((e => shouldSkip(e)))(o) ])))));
    return g([ s, c ]);
  };
};
